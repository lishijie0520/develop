...
public abstract class ScaleImageUtils {
    ...
    private static final String DEFAULT_FILE_PATH = "/Users/hsm/Desktop/images/";
    ...
    public static void main(String[] args) throws ImageFormatException, MalformedURLException, IOException {
        // 
        File file = new File("/Users/hsm/git/develop/src/test/resources/test222.jpg");
        ...
        //System.out.println(ScaleImageUtils.resize(256, 80, null, resource));
        //ScaleImageUtils.resize(512, 160, ImageQuality.max.getQuality(), null, ImageIO.read(resource));
        resizeByHeight(80, "/Users/hsm/git/develop/src/test/resources/test222-2222.jpg", file);
